...
(* OASIS_START *)
(* DO NOT EDIT (digest: bf3e7dab0b68ede2c3a8cd9647ffb93b) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("stdext", None);
                           InternalLibrary "squeeze";
                           FindlibPackage ("xenctrl", None);
                           FindlibPackage ("xenstore", None);
                           FindlibPackage ("xenstore.unix", None);
                           FindlibPackage ("xenstore_transport", None);
                           FindlibPackage ("xenstore_transport.unix", None);
                           FindlibPackage ("rpclib", None);
                           FindlibPackage ("xcp", None);
                           FindlibPackage ("xcp.memory", None);
                   ...
                   {exec_custom = false; exec_main_is = "squeezed.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "squeeze_test_main.ml"
                   });
               Test
                 ({
                     cs_name = "smoke";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "-\233AJ\025\176y\176\228ilt\022\208_\145";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
